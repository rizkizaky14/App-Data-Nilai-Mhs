...
public class DataNilaiMhs extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableMhs.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIM", "Nama", "J.Kelamin", "Jurusan", "Semester", "Nilai Pemrograman II", "Grade", "Total Biaya"
            }
        ));
        ...
        tableNilai.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIM", "Nilai Kehadiran", "Nilai Tugas", "nilai UTS", "nilai UAS", "Total Nilai"
            }
        ));
        ...
        PanelUtamaLayout.setHorizontalGroup(
            ...
            .addGroup(PanelUtamaLayout.createSequentialGroup()
                ...
                .addGroup(PanelUtamaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(panelTableMhs, javax.swing.GroupLayout.DEFAULT_SIZE, 0, Short.MAX_VALUE)
    ...
    try {
        ...
        try (PreparedStatement pst = conn.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                ...
                Object[] rowData = {nim, nama, j_kelamin, jurusan, semester, nilai_pemrog2, grade, totalBiaya};
    ...
    try {
        ...
        try (PreparedStatement pst = conn.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                ...
                Object[] rowData = {nim, NilaiKehadiran, NilaiTugas, NilaiUts, NilaiUas, NilaiPemrog2};
                model.addRow(rowData);
            }
        }
    } catch (SQLException e) {
...
//    DefaultTableModel model = (DefaultTableModel) tableMhs.getModel();
    model.addRow(new Object[]{nim, nama, gender, jurusan, semester, nilai, grade, totalBiaya});
    //====================================================================================================
    ...
    // Menambahkan data ke dalam tabel
//    DefaultTableModel nilaiModel = (DefaultTableModel) tableNilai.getModel();
    nilaiModel.addRow(new Object[]{NIM, NilaiKehadiran, NilaiTugas, NilaiUts, NilaiUas, NilaiTotal});     
    ...
    private void pushDatabaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pushDatabaseActionPerformed
        ...
        Integer nim = (Integer) tableMhs.getValueAt(i, 0);
        String nama  = (String) tableMhs.getValueAt(i, 1);
        String j_kelamin = (String) tableMhs.getValueAt(i, 2);
        String jurusan = (String) tableMhs.getValueAt(i, 3);
        String semester = (String) tableMhs.getValueAt(i, 4);
        //Ambil nilai pemrog2 dan ubah menjadi String
        double nilai_pemrog2 = (double) tableMhs.getValueAt(i, 5);
        String nilai_pemrog2String = Double.toString(nilai_pemrog2);
        String grade = (String) tableMhs.getValueAt(i, 6);
        Integer totalBiaya = (Integer) tableMhs.getValueAt(i, 7);
//        Integer totalBiaya = Integer.valueOf((String) tableMhs.getValueAt(i, 7));
        ...
        //Ambil Niali dari setiap kolom
        Integer NIM = (Integer) tableNilai.getValueAt(a, 0);
        Integer NilaiKehadiran = (Integer) tableNilai.getValueAt(a, 1);
        Integer NilaiTugas = (Integer) tableNilai.getValueAt(a, 2);
        Integer NilaiUts = (Integer) tableNilai.getValueAt(a, 3);
        Integer NilaiUas = (Integer) tableNilai.getValueAt(a, 4);
        Double NilaiPemrog2 = (Double) tableNilai.getValueAt(a, 5);
     ...
     private void saveToDatabase(int nim, String nama,String j_kelamin,String jurusan,String semester,String nilai_pemrog2String,String grade,int totalBiaya) {
        try {
            Connection conn = DatabaseConnection.connect();
     ...
     private void saveToDatabaseNilai(int NIM, int NilaiKehadiran, int NilaiTugas,int NilaiUts,int NilaiUas,Double NilaiPemrog2) {
        try {
            Connection conn = DatabaseConnection.connect();
